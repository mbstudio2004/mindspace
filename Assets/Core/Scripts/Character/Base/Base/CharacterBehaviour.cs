...
namespace Nocci.Character
{
    public abstract class CharacterBehaviour : MonoBehaviour
    {
        ...
        protected bool IsBehaviourEnabled { get; private set; }
#else
        ...
        private void OnEnable()
        {
            if (Character == null)
            {
                Character = gameObject.GetComponentInRoot<CharacterBase>();

                if (Character == null)
                {
                    UnityEngine.Debug.LogError("No character found in the parent game objects.");
                    return;
                }
            }
        ...
        /// <summary>
        ///     Gets called after the parent character has been initialized. (acts similarly to the Monobehaviour "OnEnable"
        ///     callback).
        /// </summary>
        ...
        /// <summary>
        ///     Gets called when this behaviour gets disabled, only if this behaviour has been initialized. (acts similarly to the
        ///     Monobehaviour "OnDisable" callback).
        /// </summary>
