...
namespace Nocci.Character.Character.Modules
{
    ...
    public abstract class CharacterVitalModule : MonoBehaviour
    {
        ...
        [SerializeField]
        [InfoBox ("After the stat value croses this threshold the character will start taking damage.", InfoMessageType.None)]
        ...
        [SerializeField]
        [InfoBox("After the stat value croses this threshold the character's health will start to restore", InfoMessageType.None)]
