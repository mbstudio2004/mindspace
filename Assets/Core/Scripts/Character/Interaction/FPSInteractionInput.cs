...
namespace Nocci.Player.Input
{
    [AddComponentMenu("Nocci/Input/Interaction Input")]
    public class FPSInteractionInput : CharacterInputBehaviour
    {
        [Title("Actions")] [SerializeField] private InputActionReference m_InteractInput;
        ...
        {
            m_InteractionHandler.StopInteraction();
        }
