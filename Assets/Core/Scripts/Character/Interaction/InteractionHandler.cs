...
namespace Nocci.Interaction
{
    ...
    {
        [SerializeField] [Tooltip("The transform used in raycasting.")]
        ...
        [SerializeField] [Tooltip("The trigger colliders interaction mode.")]
        private QueryTriggerInteraction m_TriggerInteraction = QueryTriggerInteraction.Ignore;

        [SerializeField] [Tooltip("Interaction layer mask, everything this handler can 'see'.")]
        ...
        public void StartInteraction()
        {
            ...
            //  Nocci.Character.AudioPlayer.PlaySound(m_FailedSound);
        }
        ...
        {
            var endTime = Time.time + m_Interactable.HoldDuration;
