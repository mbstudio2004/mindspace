...
namespace Nocci
{
    ...
    public class GuidManager
    {
        ...
        {
            if (Instance == null) Instance = new GuidManager();
        ...
        public static GameObject ResolveGuid(Guid guid, Action<GameObject> onAddCallback,
        ...
        private GameObject ResolveGuidInternal(Guid guid, Action<GameObject> onAddCallback,
            Action onRemoveCallback)
        {
            GuidInfo info;
            if (guidToObjectMap.TryGetValue(guid, out info))
