...
using Nocci.Zayebunny.State_Machine.Interfaces;
using UnityEngine;

namespace Nocci.Zayebunny.State_Machine
{
    /// <summary>
    ...
    public class StateMachine
    {
        ...
        private IEnumerator Play()
        {
            if (!m_PlayLock)
            {
                ...
                m_CurrentPlayCoroutine = Play().Run();
