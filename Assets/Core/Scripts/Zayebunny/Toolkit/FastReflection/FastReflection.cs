...
namespace Nocci.Zayebunny.FastReflection
{
    ...
    /// <summary>
    ///     A dynamic reflection extensions library that emits IL to set/get fields/properties, call methods and invoke
    ///     constructors
    ///     Once the delegate is created, it can be stored and reused resulting in much faster access times than using regular
    ///     reflection
    ///     The results are cached. Once a delegate is generated, any subsequent call to generate the same delegate on the same
    ///     field/property/method will return the previously generated delegate
    ///     Note: Since this generates IL, it won't work on AOT platforms such as iOS an Android. But is useful and works very
    ///     well in editor codes and standalone targets
    /// </summary>
    public static class FastReflection
    {
        ...
        private static readonly ILEmitter emit = new();
        private static readonly Dictionary<int, Delegate> cache = new();

        /// <summary>
        ///     Generates or gets a strongly-typed open-instance delegate to the specified type constructor that takes the
        ///     specified type params
        /// </summary>
        public static CtorInvoker<T> DelegateForCtor<T>(this Type type, params Type[] paramTypes)
        {
            var key = kCtorInvokerName.GetHashCode() ^ type.GetHashCode();
        ...
        /// <summary>
        ///     Generates or gets a weakly-typed open-instance delegate to the specified type constructor that takes the specified
        ///     type params
        /// </summary>
        ...
        /// <summary>
        ///     Generates or gets a strongly-typed open-instance delegate to get the value of the specified property from a given
        ///     target
        /// </summary>
        ...
        /// <summary>
        ///     Generates or gets a weakly-typed open-instance delegate to get the value of the specified property from a given
        ///     target
        /// </summary>
        ...
        /// <summary>
        ///     Generates or gets a strongly-typed open-instance delegate to set the value of the specified property on a given
        ///     target
        /// </summary>
        ...
        /// <summary>
        ///     Generates or gets a weakly-typed open-instance delegate to set the value of the specified property on a given
        ///     target
        /// </summary>
        ...
        /// <summary>
        ///     Generates a assembly called 'name' that's useful for debugging purposes and inspecting the resulting C# code in
        ///     ILSpy
        ...
        ///     if 'targetType' and 'ctorParamTypes' are not null, it generates a constructor for the target type that takes the
        ///     specified arguments
        /// </summary>
            ...
            MethodInfo method, Type targetType, Type[] ctorParamTypes)
        {
            ...
            if (field != null)
            {
                ...
                emit.il = buildMethod("FieldSetter", typeof(void),
                    new[] { typeof(TTarget).MakeByRefType(), fieldType });
            ...
            if (property != null)
            {
                ...
                emit.il = buildMethod("PropertySetter", typeof(void),
                    new[] { typeof(TTarget).MakeByRefType(), propType });
                    ...
                    if (field.IsLiteral)
                    {
                        if (field.FieldType == typeof(bool))
                            ...
                            throw new NotSupportedException(string.Format(
                                "Creating a FieldGetter for type: {0} is unsupported.", field.FieldType.Name));
                    }
                    else
                    {
        ...
        private static void GenMemberGetter<TTarget>(MemberInfo member, Type memberType, bool isStatic,
        ...
        private static void GenMemberSetter<TTarget>(MemberInfo member, Type memberType, bool isStatic,
