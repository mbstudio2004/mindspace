    ...
    public static class SerializedPropertyExtensions 
	{
		public static void SetValue<T>(this SerializedProperty property, T value) 
		{
			...
			foreach(var child in children)
			{
				...
				if(child.Contains("["))
				{
					var arrayName = child.Substring(0, child.IndexOf("[", StringComparison.Ordinal));
					var index = System.Convert.ToInt32(child.Substring(child.IndexOf("[", StringComparison.Ordinal)).Replace("[", "").Replace("]", ""));
