...
namespace Nocci.Utils
{
    public static class InputUtils
    {
            ...
            Action<InputAction.CallbackContext> callback)
        {
            ...
            {
                Debug.LogWarning(
                    "The passed input action is null, you need to set it in the inspector for this input to work.");
                return;
            }
        ...
        public static void UnregisterPerfomed(this InputActionReference actionRef,
            Action<InputAction.CallbackContext> callback)
        {
            if (actionRef == null)
                return;
