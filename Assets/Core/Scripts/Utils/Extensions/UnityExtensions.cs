...
namespace Nocci.Utils
{
    public static class UnityExtensions
    {
        ...
        public static void SetLocalPositionAndRotation(this Transform trs, Vector3 localPosition,
        ...
        {
            return transform.right * localPosition.x + transform.up * localPosition.y +
...
#if UNITY_EDITOR
        public static List<T> FindAndGetAssetOfType<T>() where T : Object
        {
            List<T> assets = new();
